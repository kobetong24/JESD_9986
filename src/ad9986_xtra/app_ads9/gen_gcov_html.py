...
Revision = ["r0", "r1"]
all_device_names = ["ad9081", "ad9082", "ad9986", "ad9988", "ad80434", "ad80435", "ad80437", "ad80444", "ad80445"]
temp_name = 'ad9986'
...
def main():
    ...
    if generic not in all_device_names:
        print ("%s is not supported in %s" % (generic, all_device_names))
        exit()
